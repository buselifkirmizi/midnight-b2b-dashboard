...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      createAgreement: (...args_1) => {
        if (args_1.length !== 4) {
          throw new __compactRuntime.CompactError(`createAgreement: expected 4 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('createAgreement',
                                     ...
                                     'agreement.compact line 15 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_2.toValue(a_0).concat(_descriptor_2.toValue(b_0).concat(_descriptor_0.toValue(timestamp_0))),
    ...
    this.impureCircuits = { createAgreement: this.circuits.createAgreement };
    this.provableCircuits = { createAgreement: this.circuits.createAgreement };
  }
  initialState(...args_0) {
    if (args_0.length !== 1) {
  ...
  _createAgreement_0(context, partialProofData, a_0, b_0, timestamp_0) {
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_7.toValue(1n),
                                                                                              alignment: _descriptor_7.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(a_0),
                                                                                              alignment: _descriptor_2.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_7.toValue(2n),
                                                                                              alignment: _descriptor_7.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(b_0),
                                                                                              alignment: _descriptor_2.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
